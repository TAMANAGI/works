<template>
  <div id="unity" class="view-root" :class="[data.type, data.color]">
    <unity class="unity" src="unityBuild/Build/ball/UnityLoader.js">
    ...
    computed: mapState({
      data: (state) => {
        ...
        return {
          type,
          color,
          sockState: state => state.websocket.sockState,
          conversationList: state => state.websocket.recievedData,
        };
      },
    }),
    components: {
